...
Git geklont werden. Bei Git handelt es sich um verteiltes
...
Workspace importiert. Diese Schritte wiederholt man im Anschluss für das {\em
...
Danach muss die Bibliothek noch zum {\em Java Classpath} hinzugefügt werden.
...
macht man einen Rechtsklick auf das Package und wählt {\em New} und {\em Class}
aus. Unter {\em Name} gibt man den Namen {\em HelloWorldPlugin} ein und bei {\em
Superclass} wählt man mit einem Klick auf Browse die Klasse {\em AbstractPlugin}
...
HelloWorldRegister}, die von {\em XMLPluginRegister} erbt. Zu der Klasse fügt
...
Im nächsten Schritt kann jetzt das eigentliche Plug-In installiert werden. Dazu
...
Bevor mit der eigentlichen Implementierung begonnen werden kann, müssen noch
