...
\label{cha:leitfaden}
In diesem Kapitel wird erklärt, wie man mithilfe der Eclipse \acs{ide}, Plug-Ins
für den {\em Mobile Data Collector} entwickeln kann. Das schließt neben der
Entwicklung der Smartphone-Komponente auch die Serverkomponente ein. Das Kapitel
ist in drei Teile gegliedert. Im ersten wird erklärt, wie man die nötigen
Frameworks zur Entwicklung von Plug-Ins, sowie deren Serverkomponente beziehen
kann. Im zweiten wird die Entwicklung eines einfachen Plug-Ins erklärt, und im
letzten die Entwicklung der dazugehörigen Serverkomponente. Das hierbei
entwickelte Plug-In trägt den Arbeitstitel ``Hallo Welt''-Plug-In. Das Plug-In
speichert bei jeder Ausführung den Text ``Hallo Welt'' in der Datenstruktur des
{\em Mobile Data Collectors}. Dieses Kapitel verzichtet aus
Gründen der Einfachheit, auf die Verwendung von {\em Android System Services}.
