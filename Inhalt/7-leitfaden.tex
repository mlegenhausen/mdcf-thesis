...
aus Einfachheitsgründen, auf die Verwendung von {\em Android System Services}.
Beispiele dazu können dem Abschnitt \ref{cha:evaluation} entnommen werden.
...
\begin{enumerate}
  ...
  befolgt werden.
  \item Installation des \acf{adt} Plug-In für Eclipse.
...
Die zurzeit verfügbaren sicheren {\em Android System Services} sind:
...
\ref{additionalparameters} dargestellt. In diesem werden alle verfügbaren {\em
Android System Services} angefordert und der {\em Workspace} wird nach der
Erstellung einer Übertragung nicht mehr gelöscht.
