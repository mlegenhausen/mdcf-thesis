...
\begin{itemize}
  ...
  Anwendung, die die komplette Anwendungslogik zur Ausführung von Erweiterungen
  enthält.
...
Services zugegriffen werden. Die Services bieten weitestgehend alle in der
Android Dokumentation beschriebenen Methoden. Neben den Services kann auch auf
einen {\em PersistenceManager} zugegriffen werden. Dieser erlaubt über die {\em
...
Plug-In auf die Android System Services (grau) zugreifen, geschieht das aus
...
\begin{itemize}
  ...
  auf die sicheren Android System Services vom {\em Mobile Data Collector}.
...
entsprechende Schnittstelle auf den Service zu. Der {\em Plug-In Service} läuft
dauerhaft im Hintergrund und führt die Plug-Ins in den vorgegebenen
Zeitabständen aus.
...
\begin{itemize}
  ...
  Betriebssystem benötigt. Im besten Fall ist das Attribut leer, da
...
gespeichert. Das Plug-In gilt somit als registriert. Die weitere Verwaltung
...
Plug-Ins. Mit Aktivitäten ist der Zugriff auf die sicheren Android System
...
dieser Ausführung wurde zur Lokalisierung des Benutzers das GSM/UMTS Netz ({\em
...
zugegriffen werden. Hardware wie z.~B. \acs{gps} oder der Lagesensor
werden aus jenem Gründen als System Service angeboten. Es gibt aber auch
Hardware, die nur von einer Anwendung zurzeit verwendet werden kann. Das sind
z.~B. die Kamera und das Mikrofon. Diese werden nicht als System Service angeboten, sondern als
Schnittstelle zu einer nativen Bibliothek, welche die Hardware ansteuern kann.

Android System Services lassen sich sehr einfach durch eine neue Implementierung
ersetzen, weil Android System Services selbst zur
...
Dateien speichern. Man könnte nun die Klassen wie die Services durch eine
sichere Implementierung ersetzen, indem man ebenfalls den \acs{ipc}-Mechanismus
verwendet, um die Ausführung in den {\em Mobile Data Collector} zu verschieben.
Hierbei ergibt sich aber das Problem, dass die aufgenommenen Daten in einer
Datei im {\em Mobile Data Collector} gespeichert werden. Die Datei wäre für
...
hingewiesen. Da die eigentlichen zu übertragenden Daten weiterhin zentral
