...
auf Github unter der Adresse \url{https://github.com/mlegenhausen/mdcf}
bezogen werden. Das Projekt ist dabei in die folgenden Teile gegliedert:
...
gespeicherter Daten über die {\em getWorkspace}-Methode. Die zurückgegebene
...
installiert werden. Um den Android Market schneller zu erreichen, kann wie in
...
Nach der Aktivierung eines Plug-In wechselt entsprechend die Anzeige von {\em
...
um die eigentlichen Log-Einträge. In diesem Fall sagen die Log Einträge aus, das
...
betrachten. Hierbei handelt es sich um einen Schnappschuss des aktuellen
...
Servlet} empfängt die vom {\em Mobile Data Collector} versandte \acs{json}
...
Die Serverkomponente wurde dabei mit Hilfe des {\em Dependency Injection}
...
Während der Realisierung des {\em Mobile Data Collectors} trat bei der Plug-In
...
zugegriffen werden. Diese Hardware wie z.B. \acs{gps} oder der Lagesensor werden
aus diesen Gründen als System Service angeboten. Es gibt aber auch Hardware die
nur von einer Anwendung zurzeit verwendet werden kann. Dies sind z.B. die Kamera
und das Mikrofon. Diese werden nicht als System Service angeboten, sondern als
...
eigentlichen dahinter liegende Service Implementierung den \acs{ipc} Mechanismus
...
indem man ebenfalls den \acs{ipc} Mechanismus verwendet, um die Ausführung in
den {\em Mobile Data Collector} zu verschieben. Hierbei ergibt sich aber nun das Problem,
