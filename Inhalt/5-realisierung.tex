...
Log Record} und alle gesammelten Daten enthält, wird diese Datenstruktur 
...
Plug-In hergestellt werden, werden zuerst alle für die Ausführung nötigen
Objekte gesetzt, um daraufhin das Plug-In auszuführen. Das Plug-In wird dabei
nur maximal für die im {\em PluginInfo} angegebene Zeit ausgeführt. Sollte diese
...
Aktivitäten ist der Zugriff auf die sicheren Android System Services gemeint.
...
einfacheren Implementierung von Plug-Ins verzichtet. Stattdessen sollte in diesen Fällen die von Android zur
