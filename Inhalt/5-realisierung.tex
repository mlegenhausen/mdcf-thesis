...
Die Anwendung trägt dabei den Arbeitstitel {\em Mobile Data Collector},
...
Die zurückgegebene Datenstruktur kann dann innerhalb des Plug-Ins beliebig
...
angezeigt. Jeder anklickbare Knoten wird dabei als Datum angezeigt. Das
...
es sich dabei nur um eine Zeichenkette handelt, kann diese einfach per
\acs{http} versendet werden.
