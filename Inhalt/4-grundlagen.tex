...
\begin{itemize}
  ...
  E-Mail Anwendung. Jede {\em Activity} ist unabhängig von der anderen. Dadurch
  ...
  sein, dass der Bildschirm aus- bzw. eingeschaltet wurde. Anwendungen selbst können
  ebenfalls {\em Broadcasts} verschicken, durch die andere Anwendungen über ein
  Ereignis informiert werden können. {\em Broadcast Receiver} besitzen keine
...
oder nicht. Ein {\em Intent} ist ein einfaches Objekt, das eine Nachricht an
eine oder mehrere Komponenten spezifiziert. Dabei kann ein {\em Intent} beliebige Daten
...
Komponente definiert, auf die sie reagieren soll. Ein Beispiel für einen {\em
...
Die Sandbox erlaubt es sogar, nativen Code von einer Anwendung auszuführen,
...
Schnittstelle zur Verfügung. Der Zugriff auf eine Ressource über einen
Service kann konkurrierend stattfinden. Über die Services kann zum einen auf die
Sensorik zugegriffen werden, aber auch auf systeminterne Dienste. Da über diese auf
personenbezogene Daten und systemkritische Konfigurationen zugegriffen werden
kann, sind jene Services durch Zugriffsrechte geschützt. Die Überprüfung der
...
Klassenbibliothek~\cite{apacheharmony}. Das erlaubt die Ausführung von
...
zur Verfügung gestellt. Die Informationen können dann anderen auf dem
...
Plug-Ins werden in Form von Bundles installiert. Das Framework kümmert
...
System. Dynamix läuft als Service im Hintergrund und erlaubt durch
