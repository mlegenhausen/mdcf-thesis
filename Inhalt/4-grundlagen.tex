...
der beschreibt wie diese erstellt und zerstört werden.
...
sowie die {\em \acf{ipc}} eingegangen, da diese zum Verständnis der Masterarbeit
erforderlich sind.
...
Verfügung. Der Zugriff auf eine Ressource über einen Service kann konkurrierend
stattfinden. Über die Services kann zum einen auf die Sensorik zugegriffen
werden, zum anderen auf systeminterne Dienste. Da über diese auf
...
Android-Sys\-tem. Dynamix läuft als Service im Hintergrund und erlaubt durch
...
eignet, und somit auch für die Verwendung auf mobilen Geräten wie Smartphones,
...
anhand eines Beispielobjektes nach ähnlichen Objekten gesucht. Bei Critera
Queries werden \acs{sql} Anfragen durch eine Verkettung von Methodenaufrufen
nachgebildet und bei nativen Queries können beliebig komplexe Suchanfragen in
