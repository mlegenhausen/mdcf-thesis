...
Objekt, das eine Nachricht an eine oder mehre Komponenten spezifiziert. Dabei
kann ein {\em Intent} beliebige Daten enthalten, die zur Erfüllung der Aufgabe
in der anderen Komponente benötigt werden. Dies kann z.B. dazu genutzt werden,
...
\begin{itemize}
  ...
  \item Jede Anwendung läuft in ihrer eigenen \acs{vm}, so dass jede
