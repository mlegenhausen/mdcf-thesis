...
das Plug-In System, nachdem über die Installation eines neuen Plug-Ins per
{\em Broadcast} benachichtigt wurde, einen {\em Broadcast} an das neu installierte
Plug-In schicken. Das neue Plug-In soll daraufhin mit entsprechenden Plug-In
...
Daten kontrolliert wird. Da der Zugriff auf die Daten innerhalb von Android
über System Services geschieht, muss der Zugriff kontrolliert stattfinden. Es
...
Implementierungen der Android Services. Die sicheren Services sollen jeden
...
Plug-In trotzdem versuchen auf einen Android System Service zuzugreifen, soll
...
Darstellungswert innerhalb der Liste soll bei einem Knoten das Modifizierungsdatum
...
Bei der Ausführung eines Plug-Ins soll dises vollen Zugriff, auf die
...
soll vor der Übertragung alle Aktivitäten des Plug-Ins betrachten können.
...
können. Die Übertragungen sollen übersichtlich aufgelistet werden.
...
anonymisiert sein (siehe Abschnitt \ref{anonymisation}).
...
innerhalb eines Über\-tra\-gungs\-intervalls möglich. Um das Problem zu
