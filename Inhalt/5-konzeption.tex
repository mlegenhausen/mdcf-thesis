...
Folgenden sollen die zwei Ansätze genauer betrachtet werden.
...
heruntergeladen und installiert werden kann. Die Infrastruktur ist also schon vorhanden. Auch ist
...
Möglichkeit erhalten zu entscheiden, ob ein Plug-In wirklich verwendet werden
soll oder nicht.

Ein Plug-In soll bestimmte Zustände einnehmen können. Nach der
...
den Transferzustand übergeben. Die Zeitspanne soll bei der Plug-In
Registrierung angegeben werden. In diesem Zustand sollen die Daten für die
Übertragung aufbereitet und lokal gespeichert werden. Wann die Daten
...
Plug-In System die gespeicherten Daten vom Plug-In zu löschen und die Plug-In
...
Dabei sollen einem Plug-In nicht von vorne rein alle {\em Android System
...
Das entwickelte Konzept erweitert die von Android zur Verfügung
...
zuvor gespeicherten Daten, besitzen. Dadurch soll die Möglichkeit bestehen zuvor
...
können. Alle Übertragungen sollen übersichtlich aufgelistet werden.
...
anerkannter Standard zur Übertragung von Daten übers Internet~\cite{json}.
...
notwendig, wenn man z.~B. die Bewegungen von Personen über einen längeren
...
Konkatenation aus Plug-In Action und \acs{imsi} und der anschließenden Anwendung eines
