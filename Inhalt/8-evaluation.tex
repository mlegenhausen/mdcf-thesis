...
Criteria}-Objekt entspricht. Durch das Objekt können Kriterien wie z.~B. Stromverbrauch und Genauigkeit
...
{\em Workspace} angehängt und gespeichert.
...
Das geschieht ebenfalls über die {\em plugin.xml}. Eine mögliche Konfiguration
...
LocationManager} wird zur Ermittlung der aktuellen Position benötigt. Es ist
...
Empfang, an einen {\em TransferRequestProcessor} übergeben. In der Klasse kann
...
Benutzer angehängt, da andernfalls ein neuer {\em Participant} erstellt wird.
...
{\em Google Maps \acs{api}} für \acs{gwt} verwendet~\cite{gwtmaps}.
...
verwendet werden, Audio- und Videoaufnahmen durchzuführen. In den darauf folgenden
...
hinzuweisen, dass die maximale Amplitude zwischen verschiedenen Geräten
...
der Über\-tra\-gung des allgemeinen Datenmodells auf das domänenspezifische muss
ein entsprechendes Attribut für die Amplitude vorgesehen werden.
