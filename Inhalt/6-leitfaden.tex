...
Serverkomponente beziehen kann. Im Zweiten wird erklärt, wie man ein einfaches
Plug-In entwickeln kann und im Letzten die dazugehörige Serverkomponente. Das
hierbei entwickelte Plug-In trägt den Arbeitstitel ``Hallo Welt''-Plug-In.
...
\begin{itemize}
  ...
  \item {\bf services}: Gibt an, welche sicheren Android Services beim Plug-In
...
\begin{itemize}
  ...
  aktuelle Position des Benutzers zu ermitteln.
...
Einträge erweitert. Einmal um einen {\em Broadcast Receiver} (Zeile 12 bis 18)
und dem Plug-In, der als {\em Service} definiert wird (Zeile 20 bis 26). Der
